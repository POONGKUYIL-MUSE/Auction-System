...
var t = 5000;
//var op = (document.getElementById('priceamt')).value;
//var t = parseInt(op,10);
var price = t.toFixed(2);
//var price = p2.toString();
...
function onBuyClicked() {
  createPaymentRequest()
      ...
      .then(function(response) {
        ...
        window.location.assign('successPay.php');
      })
      .catch(function(err) {
        showErrorForDebugging(
            'show() error! ' + err.name + ' error: ' + err.message);
        window.location.assign('failPay.php');
      });
...
function createPaymentRequest() {
  ...
  const details = {
    total: {label: 'Test Purchase', amount: {currency: 'USD', value: price}}
  };
